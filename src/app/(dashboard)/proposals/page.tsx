    ...
    return (
        <div className="p-8">
            ...
            <div className="p-12 border-2 border-dashed border-slate-200 rounded-3xl flex flex-col items-center justify-center text-slate-500 bg-slate-50/50">
                <p className="text-lg font-medium italic underline underline-offset-4 decoration-amber-500">Proposal Generation & Archive</p>
                <p className="mt-2 text-sm">Loading documentation templates...</p>
            </div>
        </div>
    )
}
